...
Installing aeneas
=================
Make sure you have ffmpeg, ffprobe (usually provided by the ffmpeg package), and espeak installed and available on your command line. Details at https://github.com/readbeyond/aeneas/blob/master/wiki/INSTALL.md#installing-aeneas . Then install aeneas as usual.

Copied from https://github.com/avinashvarna/audio_alignment/blob/main/utils/alignment.py .
